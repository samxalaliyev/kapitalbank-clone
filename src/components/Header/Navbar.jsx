        ...
        <div className="container">
          <div className="navmain">
            <ul className="nav-ul">
              ...
              <li className="ul-child">İpotekalar</li>
              <li className="ul-child">Depozitlər</li>
              <li className="ul-child">Pul Köçürmələri</li>
              <li className="ul-child">Onlayn Xidmətlər</li>
              <li className="ul-child">Kampaniyalar</li>
              <li className="ul-child">Fərdi Bankçılıq</li>
            </ul>
